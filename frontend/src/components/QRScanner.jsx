...
const QRScanner = () => {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      setMessage('Could not read a QR code from this image. Please try a clearer photo.');
      setMessageType('error');
    } finally {
      setUploading(false);
    }
    ...
    <div className="flex flex-col items-center">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-sm w-full">
        ...
        <p className="text-sm text-gray-500 text-center mb-5">
          Use your camera or upload a screenshot of the QR code
        </p>
        ...
        {mode === 'upload' && (
          <>
            ...
            <button
              ...
              disabled={uploading}
              className="w-full border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 hover:bg-blue-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {uploading ? (
      ...
      <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4 max-w-sm w-full">
        ...
        {mode === 'camera' ? (
          ...
          <ul className="text-xs text-green-700 space-y-1">
            ...
            <li>2. Click the upload area and select the image</li>
